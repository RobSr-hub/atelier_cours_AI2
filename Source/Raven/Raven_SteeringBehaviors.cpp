...
Raven_Steering::Raven_Steering(Raven_Scene* world, Raven_Bot* agent):
             ...
             m_pRaven_Bot(agent),
             m_iFlags(0),
             m_dWeightSeparation(config.GetDouble("SeparationWeight")),
             m_dWeightWander(config.GetDouble("WanderWeight")),
             m_dWeightWallAvoidance(config.GetDouble("WallAvoidanceWeight")),
             m_dViewDistance(config.GetDouble("ViewDistance")),
             m_dWallDetectionFeelerLength(config.GetDouble("WallDetectionFeelerLength")),
             m_Feelers(3),
             ...
             m_dWeightSeek(config.GetDouble("SeekWeight")),
             m_dWeightArrive(config.GetDouble("ArriveWeight")),
