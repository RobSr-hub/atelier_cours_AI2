...
Blaster::Blaster(Raven_Bot*   owner):
                      ...
                      Raven_Weapon(type_blaster,
                                   config.GetInt("Blaster_DefaultRounds"),
                                   config.GetInt("Blaster_MaxRoundsCarried"),
                                   config.GetDouble("Blaster_FiringFreq"),
                                   config.GetDouble("Blaster_IdealRange"),
                                   config.GetDouble("Bolt_MaxSpeed"),
                                   owner)
{
...
{ 
  if (isReadyForNextShot())
  {
    ...
    m_pOwner->GetWorld()->GetMap()->AddSoundTrigger(m_pOwner, config.GetDouble("Blaster_SoundRange"));
  }
}
