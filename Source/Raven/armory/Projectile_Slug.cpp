...
Slug::Slug(Raven_Bot* shooter, Vector2D target):
        ...
        Raven_Projectile(target,
                         ...
                         shooter->Pos(),
                         shooter->Facing(),
                         config.GetInt("Slug_Damage"),
                         config.GetDouble("Slug_Scale"),
                         config.GetDouble("Slug_MaxSpeed"),
                         config.GetDouble("Slug_Mass"),
                         config.GetDouble("Slug_MaxForce")),

        m_dTimeShotIsVisible(config.GetDouble("Slug_Persistance"))
{
