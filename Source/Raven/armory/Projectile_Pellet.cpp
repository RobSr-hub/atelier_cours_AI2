...
Pellet::Pellet(Raven_Bot* shooter, Vector2D target):
        ...
        Raven_Projectile(target,
                         ...
                         shooter->Pos(),
                         shooter->Facing(),
                         config.GetInt("Pellet_Damage"),
                         config.GetDouble("Pellet_Scale"),
                         config.GetDouble("Pellet_MaxSpeed"),
                         config.GetDouble("Pellet_Mass"),
                         config.GetDouble("Pellet_MaxForce")),

        m_dTimeShotIsVisible(config.GetDouble("Pellet_Persistance"))
{
