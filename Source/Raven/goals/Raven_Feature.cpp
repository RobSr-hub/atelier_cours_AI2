...
double GetMaxRoundsBotCanCarryForWeapon(int WeaponType)
{
  ...
  case type_rail_gun:
    ...
    return config.GetDouble("RailGun_MaxRoundsCarried");

  case type_rocket_launcher:

    return config.GetDouble("RocketLauncher_MaxRoundsCarried");

  case type_shotgun:

    return config.GetDouble("ShotGun_MaxRoundsCarried");
